...
# B#videostream = VideoStream.VideoStream((IM_WIDTH,IM_HEIGHT),FRAME_RATE,1,0).start()
...
while cam_quit == 0:
    ...
    # B#image = videostream.read()

    image = cv2.imread("20220830_175240.jpg")
